...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
     ...
     * by RecyclerView.
     */
    public CustomAdapter(ArrayList<EndpointDataView> dataSet) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.endpoint_entry, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        switch (endpointDataView.getAction()) {
            case NearbyBertyNativeDriver.ACTION_FOUND_ENDPOINT:
                ...
                break;
            case NearbyBertyNativeDriver.ACTION_LOST_ENDPOINT:
                viewHolder.getTextView().setTextColor(Color.GRAY);

                break;
            case NearbyBertyNativeDriver.ACTION_CONNECTED_ENDPOINT:
                viewHolder.getTextView().setTextColor(Color.GREEN);

                break;
            case NearbyBertyNativeDriver.ACTION_DISCONNECTED_ENDPOINT:
